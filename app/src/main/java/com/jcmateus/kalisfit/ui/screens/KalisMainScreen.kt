...
fun KalisMainScreen(mainNavController: NavHostController) {
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            bottomBar = {
                NavigationBar { // Considera usar NavigationBar de Material3 si aún no lo haces
            ...
            // El lambda del Scaffold SÍ recibe PaddingValues, que has llamado 'contentPadding'
        ) { contentPadding ->
            NavHost(
